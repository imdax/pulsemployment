        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-6 leading-relaxed text-sm">
              ...
              We're reshaping the future of employment through innovation and
              dedication.
            </p>
            <div className="flex space-x-4">
              {[
                {
                  Icon: PiFacebookLogo,
                  link: "https://www.facebook.com/profile.php?id=61586498556684",
                },
          ...
          <div>
            ...
            <ul className="space-y-4">
              {["Home", "About Us", "Jobs", "How It Works", "Contact"].map(
                (item) => (
                  <li key={item}>
                    <Link
                      to={
                        item === "Home"
                          ? "/"
                          : `/${item.toLowerCase().replace(/\s+/g, "-").replace("about-us", "about")}`
                      }
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center space-x-3 text-gray-400 text-sm">
                ...
                <span>+61 417 713 034 / +61 461 525 878</span>
              </li>
              <li className="flex items-center space-x-3 text-gray-400 text-sm">
