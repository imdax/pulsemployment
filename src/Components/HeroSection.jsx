    ...
    <div className="relative w-full bg-white">
          ...
          >
            ...
            <div className="w-full lg:w-2/3 text-white z-20">
              ...
              >
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-100 via-white to-blue-100 animate-shimmer bg-[size:200%_auto]">
                  Workforce Solutions
                </span>
              </motion.h1>
              <motion.p
                variants={itemVariants}
                className="text-gray-200 text-lg md:text-xl mb-8 max-w-xl leading-relaxed font-light"
              >
                We help skilled professionals secure verified job opportunities
                in Australia through a structured recruitment and eligibility
                assessment process trusted by employers.
              </motion.p>
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-24 mb-12">
        ...
        >
          ...
          <motion.div
            variants={itemVariants}
            className="bg-white rounded-lg p-8 shadow-xl hover:-translate-y-2 transition-transform duration-300 border-t-4 border-[var(--color-primary-red)]"
          >
          ...
          >
            ...
            <p className="text-gray-600 leading-relaxed">
              Candidates are screened based on skills, experience, and role
              suitability.
            </p>
          </motion.div>
